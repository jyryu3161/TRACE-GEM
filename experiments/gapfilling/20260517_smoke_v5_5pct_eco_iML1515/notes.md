...
organism filter elapsed: 181.02s
depleted.solver set to gurobi
running cobra.flux_analysis.gapfilling.gapfill(lower_bound=0.05, universal_size=4664)...
gap-fill done in 86.73s, added=0, failure_mode=error: RuntimeError: Failed to validate gap filled model, try lowering the integer threshold.
metrics: recall=0.000, precision=n/a, jaccard=0.000, growth_ratio=0.000, overhead=-113, elapsed=278.39s
```
