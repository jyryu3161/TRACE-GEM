...
organism filter elapsed: 223.92s
depleted.solver set to gurobi
running cobra.flux_analysis.gapfilling.gapfill(lower_bound=0.05, universal_size=166)...
gap-fill done in 0.26s, added=0, failure_mode=infeasible: gap filling optimization failed (infeasible).
metrics: recall=0.000, precision=n/a, jaccard=0.000, growth_ratio=-0.000, overhead=-3, elapsed=230.21s
```
